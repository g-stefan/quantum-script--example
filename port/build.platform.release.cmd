...
call :cmdX cmd.exe /C "port\build.mingw64.cmd release"
call :cmdX cmd.exe /C "port\build.mingw64.cmd clean"

call :cmdX cmd.exe /C "port\build.mingw32.cmd clean"
call :cmdX cmd.exe /C "port\build.mingw32.cmd release"
call :cmdX cmd.exe /C "port\build.mingw32.cmd clean"

call :cmdX cmd.exe /C "port\build.wsl-ubuntu-20.04.cmd clean"
call :cmdX cmd.exe /C "port\build.wsl-ubuntu-20.04.cmd release"
call :cmdX cmd.exe /C "port\build.wsl-ubuntu-20.04.cmd clean"

call :cmdX cmd.exe /C "port\build.wsl-ubuntu-18.04.cmd clean"
call :cmdX cmd.exe /C "port\build.wsl-ubuntu-18.04.cmd release"
call :cmdX cmd.exe /C "port\build.wsl-ubuntu-18.04.cmd clean"
