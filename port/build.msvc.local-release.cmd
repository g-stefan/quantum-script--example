...
echo -^> local-release quantum-script-extension-example
...
call :cmdX xyo-cc quantum-script-extension-example --archive-release-sha512 --version-file=source/quantum-script-extension-example.version.ini
